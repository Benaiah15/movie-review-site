...
export const revalidate = 3600; // This will now actually work!
...
export default async function HomePage() {
  // We removed getServerSession from here!
  ...
  return (
    <div className="pb-20">
      ...
      {/* ================= BOTTOM CTA ================= */}
      {/* Our new CPU-safe client component handles this now! */}
      <GuestCTA />
    </div>
  );
}
