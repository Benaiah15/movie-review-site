...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    if (rememberMe) {
      ...
      sessionStorage.setItem("user_temp", "active");
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center dark:bg-zinc-950 bg-gray-50 p-4 transition-colors duration-300">
      <div className="w-full max-w-md dark:bg-zinc-900 bg-white border dark:border-zinc-800 border-gray-200 rounded-2xl p-8 shadow-xl transition-colors duration-300">
        ...
        {error && (
          <div className="bg-red-500/10 border border-red-500/50 text-red-600 dark:text-red-500 text-sm p-3 rounded-md mb-4 text-center transition-colors">
            {error}
          </div>
        )}
        ...
        <form onSubmit={loginUser} className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-3 dark:bg-zinc-950 bg-gray-50 border dark:border-zinc-800 border-gray-300 rounded-lg dark:text-white text-zinc-900 focus:outline-none focus:border-red-500 transition-colors"
            />
          </div>
          <div>
            ...
            <div className="relative">
              <input 
                ...
                className="w-full px-4 py-3 dark:bg-zinc-950 bg-gray-50 border dark:border-zinc-800 border-gray-300 rounded-lg dark:text-white text-zinc-900 focus:outline-none focus:border-red-500 pr-12 transition-colors"
              />
              <button 
                type="button"
          ...
          <div className="flex items-center gap-2 mt-2">
            <input 
              ...
              className="w-4 h-4 rounded dark:border-zinc-800 border-gray-300 dark:bg-zinc-950 bg-white accent-red-600 transition-colors"
            />
            <label htmlFor="remember" className="text-sm dark:text-zinc-400 text-zinc-600 cursor-pointer select-none transition-colors">
              Stay logged in
            </label>
          </div>
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full py-3 font-semibold text-white bg-red-600 rounded-lg hover:bg-red-700 transition disabled:opacity-50 mt-4 shadow-sm"
          >
        ...
        <button 
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 dark:bg-zinc-950 bg-white border dark:border-zinc-800 border-gray-300 rounded-lg dark:text-white text-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors shadow-sm"
        >
